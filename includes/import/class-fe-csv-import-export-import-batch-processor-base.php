<?php
/**
 * Import Batch Processor Base Class for FE CSV Import & Export
 *
 ...
 * @package FE_CSV_Import_Export
 */
abstract class FE_CSV_Import_Export_Import_Batch_Processor_Base {
	/**
	 * Process batch import.
	 *
	 * Template method. Subclasses implement the actual processing via
	 * {@see FE_CSV_Import_Export_Import_Batch_Processor_Base::do_process_batch()}.
	 *
	 * @since 0.9.8
