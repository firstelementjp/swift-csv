 ...
 *
 * Manages export cancellation flags for FE CSV Import & Export.
 *
 * @since 0.9.8
 ...
 * @package FE_CSV_Import_Export
 */
class FE_CSV_Import_Export_Export_Cancel_Manager {
	...
	public function get_cancel_option_name( string $export_session ): string {
		return 'fe_csv_import_export_export_cancelled_' . get_current_user_id() . '_' . $export_session;
	}
