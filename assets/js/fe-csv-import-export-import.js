...
function appendImportRealtimeLog({ message, level, action, status }) {
	const panelsRoot = document.querySelector('.fe-csv-import-export-logs-area');
	if (!panelsRoot) {
	...
	const logContent = document.querySelector(
		`.fe-csv-import-export-logs-area .log-panel[data-panel="${panelKey}"] .log-content`
	);
	if (!logContent) {
		addLogEntry(message, level, 'import');
		return;
...
function startAjaxImport(importMethod) {
	...
	if (cancelBtn) {
		...
		const cancelHandler = function () {
			...
			// Reset progress bar
			const cancelProgressContainer = document.querySelector('.fe-csv-import-export-progress');
...
function updateImportProgress(data, startTime) {
	...
	const logCreatedEl = document.querySelector('.fe-csv-import-export-logs-area .created-count');
	const logUpdatedEl = document.querySelector('.fe-csv-import-export-logs-area .updated-count');
	const logErrorEl = document.querySelector('.fe-csv-import-export-logs-area .error-count');
...
function completeAjaxImport(data, importBtn, cancelBtn) {
	...
	const hasTabbedImportLogs = !!document.querySelector('.fe-csv-import-export-logs-area .log-tab');
...
function initializeLogTabs() {
	const tabs = document.querySelectorAll('.fe-csv-import-export-logs-area .log-tab');
	const panels = document.querySelectorAll('.fe-csv-import-export-logs-area .log-panel');
