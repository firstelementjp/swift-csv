 ...
 * Export Log Store
 *
 * Manages transient-based export logs for FE CSV Import & Export.
 *
 * @since 0.9.8
 ...
 * @package FE_CSV_Import_Export
 */
class FE_CSV_Import_Export_Export_Log_Store {
	...
	private function get_transient_key( string $export_session ): string {
		return 'fe_csv_import_export_export_logs_' . get_current_user_id() . '_' . $export_session;
	}
