...
class FE_CSV_Import_Export_Settings_Helper {
	 ...
	 * @var string
	 */
	private const OPTION_NAME = 'fe_csv_import_export_settings';
	...
	public static function migrate_legacy_options() {
		...
		// Export logs setting.
		$legacy_export_enable_logs = get_option( 'fe_csv_import_export_export_enable_logs' );
		if ( false !== $legacy_export_enable_logs ) {
			$legacy_enable_logs = (bool) $legacy_export_enable_logs;
			delete_option( 'fe_csv_import_export_export_enable_logs' );
		}

		// Import logs setting.
		$legacy_import_enable_logs = get_option( 'fe_csv_import_export_import_enable_logs' );
		if ( false !== $legacy_import_enable_logs ) {
			...
			delete_option( 'fe_csv_import_export_import_enable_logs' );
		}
